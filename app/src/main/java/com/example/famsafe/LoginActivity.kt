...
import com.example.famsafe.MainActivity
        ...
        auth.signInWithCredential(credential)
            .addOnCompleteListener(this) { task ->
                if (task.isSuccessful) {
                    ...
                    SharedPreference.putBoolean(PrefConstant.Is_User_Logged_In,true)
                    startActivity(Intent(this, MainActivity::class.java))
                    val user = auth.currentUser

                    SharedPreference.putString(PrefConstant.Name_of_User,"${user?.displayName}")
